...
OR.state = (() => {
  ...
  function create(name,type) {data=fresh(name,type);log('Eldric placed ancestral iron in your hands. Strongwood has a defender.');save();return data;}
  ...
  return {KEY,REST_DURATION,fresh,load,save,create,reset,qty,add,log,loot,grantLoot,syncRest,restStatus,get data(){return data;},get error(){return storageError;}};
})();
