...
OR.state = (() => {
  ...
  return {KEY,REST_DURATION,remember,fresh,load,save,create,reset,qty,levelProgress,add,log,loot,grantLoot,syncRest,restStatus,get data(){return data;},get error(){return storageError;}};
})();
