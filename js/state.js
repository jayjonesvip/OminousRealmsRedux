...
OR.state = (() => {
  ...
  function create(name,type) {data=fresh(name,type);OR.village?.setup();log('Dornik Harth placed ancestral iron in your hands. Strongwood has a defender.');save();OR.analytics?.track('new_game',{weapon_type:data.weapon.type});return data;}
