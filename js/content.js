...
OR.content = (() => {
  ...
  const weapons = {
    ...
    Hammer: {pitch:'Break armor. Shatter the silence.',moves:[move('Crush',11,78,'Iron answers iron.'),move('Gravesoil Blow',20,50,'Shakes the ground. Staggers if it lands.',false,true)]},
  ...
  const items = {
    ...
    VeilboundGrimoire:{name:'Cinderseam Grimoire',art:'veil-grimoire',group:'RELICS',note:'Its shifting language is unknown. Bring it to Sereth Venn, the Ashen Sage.'},
  ...
  const entries = [
    ...
    ['Home','home','Strongwood Cottage','Smoke curls above the roof. A cobblestone path leads north toward the Crooked Kettle.','The hearth is cold. Something remembers you.'],
    ['Nature','forest','Rafterroot Forest','Sunlight cuts through the trees like ancestral steel.','Dead branches claw at a blood-red sky.'],
    ...
    ['Thing','veil-grimoire','Cinderseam Grimoire','Ancient pages wait beneath a broken arch.','Letters shift across brittle pages. A golden tree marks the cover.'],
    ['Thing','vaelric-refuge','Sereth Venn’s Refuge','A golden ward holds the dark at bay.','Deep in the ash, a golden ward burns. Sereth Venn waits within.'],
    ['Thing','veil-gate','The Cinderseam Gate','The last gate stands open.','Black iron frames a wound in the sky. Ordrath waits beyond it.'],
    ['Enemy','malrec','Ordrath, Lord of the Cinderseam','The Cinderseam’s anchor awaits.','His crown divides the crimson sky. Your weapon answers with golden light.'],
    ...
    ['Nature','stream','Sparrowbend Stream','Clear water carries the whispers of the village.','Ash floats downstream. Nothing drinks here.'],
    ['Nature','clearing','Warmfern Clearing','For a moment, the forest lets you breathe.','The clearing is quiet in all the wrong ways.'],
    ['Nature','grove','Bentroot Grove','Roots hold fast beneath the oldest trees.','The roots twist around things best left buried.'],
    ...
    ['Nature','waterfall','Hushrill Falls','Falling water drowns the distant clang of the forge.','Red mist rises where the black water breaks.'],
    ['Nature','glade','Stillbough Glade','A shaft of light finds a place the world forgot.','A shaft of crimson finds a place the world abandoned.'],
    ['Nature','marshland','Sedgepool Marsh','Reeds rustle around the slow, dark water.','Bubbles rise from a pool with no bottom.'],
    ...
    ['Food','mushrooms','Duskfrill Mushrooms','Tiny caps shine beneath a fallen branch.','Pale caps cluster in the ash beneath a blackened branch.'],
    ...
    ['Animal','fox','Russetbrush Fox','A red fox slips between gold and green.','A fox moves like a coal through the dying woods.'],
    ...
    ['Danger','snake','Ditchscale Snake','A coiled serpent claims the path ahead.','A scaled shadow uncoils in the ash.'],
    ...
    ['Danger','spider','Needleleg Spider','Silken threads shiver across the path.','A many-legged shape descends through red fog.'],
    ...
    ['Enemy','ogre','Kilnmaw Ogre','The trees shake under a heavy tread.','A crude axe drags a long scar through the ash.'],
    ['Enemy','troll','Angry Troll','A hulking shape stirs beyond the trees.','The troll lifts its hammer. The ground goes still.'],
    ['Enemy','gargoyle','Ruinperch Gargoyle','Stone wings stir in the fading light.','A stone sentinel unfolds its broken wings.'],
    ['Dragon','dragon','Sootveil Dragon','The forest itself seems to draw breath.','A green scale mountain rises through the crimson fog.'],
    ...
    ['Landmark','tavern','The Crooked Kettle','A warm hearth and a thoughtful barkeep offer a pause from the road.','A quiet tavern.'],
    ['Landmark','village-forge','Dornik Harth’s Forge','Dornik Harth tends the fire. Bring ingots from your travels.','A village forge.'],
    ...
    ['Puzzle','puzzle-plate','The Ingot Balance','An empty plate guards a cave sealed in old stone.','A cold offering plate waits before a sealed hollow.'],
    ['Puzzle','puzzle-runes','The Rune Bearings','Three carved wheels bar a forgotten woodland chamber.','Three stone wheels hold a vault against the dark.'],
